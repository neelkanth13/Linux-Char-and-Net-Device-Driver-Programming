...
void timer_callback(struct timer_list * data)
{
    ...
    /*
       ...
       */
    mod_timer(&dummy_timer, jiffies + msecs_to_jiffies(TIMEOUT));
}
...
static int __init dummy_driver_init(void)
{
    ...
    //If you face some issues and using older kernel version, 
    //then you can try setup_timer API(Change Callback function's argument to 
